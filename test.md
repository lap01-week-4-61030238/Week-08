...
namespace StackDemo
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            stack1.Clear();
            Console.WriteLine("After apply the clear method the elements in the
stack are:" + stack1.Count);
            Console.ReadLine();
        }
    }
}
...
ชนิดของไฟล์	แอพปลิเคชั่นที่ใช้เปิดไฟล์
txt	Notepad.exe
bmp	paint.exe
rtf	wordpad.exe
pdf	acrobat.exe
...
namespace HashTableDemo
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Method ContainKey()
            Console.WriteLine("The  key element \"8\" is contain in the 
Hashtable weeks : " + weeks.ContainsKey("8"));

            // Method ContainValue()
            Console.WriteLine("The  key element \"Wednesday\" is contain in the
Hashtable weeks : " + weeks.ContainsValue("Wednesday"));
