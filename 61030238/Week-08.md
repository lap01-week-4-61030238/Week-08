...
บันทึกผลการทดลอง
ที่เกิด error ขึ้นเพราะarrayที่ปะกาศมีแค่10แต่เราเก็บ11ตัวเลยเกินerror
...
บันทึกผลการทดลอง
arrayที่เราประกาศมีแค่ 0-9ไม่มีตำแหน่ง-1ทำให้เกิดerrer
...
=เกิดกว่าที่กำหนดเช่นจุ100เมื่อมีสมาชิก101ก็จะเพิ่มความจุ
2. การเพิ่มค่าความจุในอาร์เรย์ลิสต์มีลักษณะเป็นอย่างไร

=เกิดกว่าที่กำหนดเช่นจุ100เมื่อมีสมาชิก101ก็จะเพิ่มความจุไปอีก100
...
=Countยึดตามขนาดเก่า Capacityยึดตามขนาดใหม่
...
มีปัญหาlist2[4] = 77;เพราะเราสร้างlist0-3ไม่มี4
